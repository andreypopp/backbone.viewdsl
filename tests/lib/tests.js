...
define(function(require) {
  var $parseHTML, Collection, CollectionView, Compiler, Events, Model, View, extend, _ref, _ref1;
  extend = require('underscore').extend;
  _ref = require('backbone'), Events = _ref.Events, Model = _ref.Model, Collection = _ref.Collection;
  ...
  describe('View with bindings', function() {
    ...
    return describe('digest on events', function() {
      var et, renderV;
      et = extend({}, Events);
      renderV = function(t, s) {
        var MyView, v;
        MyView = (function(_super) {
